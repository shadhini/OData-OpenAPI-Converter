...
@XmlType(name = "TEntityType")
@XmlSeeAlso({TProperty.class, TNavigationProperty.class, Annotation.class })
public class TEntityType {
    ...
    @XmlElement(name = "Key", type = TEntityKeyElement.class)
    protected TEntityKeyElement keyElement;
    ...
    public TEntityKeyElement getKeyElement() {
        return keyElement;
    }

    public void setKeyElement(TEntityKeyElement keyElement) {
